...
// Xử lý ghi file khi biểu mẫu được gửi
if (isset($_POST['submit'])) {
    $filename = $_POST['filename'] . '.txt'; // Thêm đuôi .txt vào tên file

    // Lấy đường dẫn file
    $filePath = __DIR__ . '/' . $filename; // __DIR__ đảm bảo đường dẫn đúng đến thư mục hiện tại

    // Nội dung để ghi vào file
    $content = "Dữ liệu từ biểu mẫu đã được ghi vào file.\n";
    $content .= "Thời gian ghi: " . date('Y-m-d H:i:s') . "\n";

    // Ghi file
    if (file_put_contents($filePath, $content) !== false) {
        echo '<p>File đã được ghi thành công: ' . $filename . '</p>';
    } else {
        echo '<p>Không thể ghi file</p>';
    }
}
?>
    ...
    <div class="container my-3">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="images/python.png" alt="Python Programming" style="width: 100px;"></td>
